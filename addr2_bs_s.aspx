...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
	<head>
		...
		<script type="text/javascript">
			...
			,['txtProductno', 'lblProduct', 'ucc', 'noa,product', 'txtProductno', 'ucc_b.aspx']	
			);
            var q_name = "addr2_s";
	...
	<body>
		<div style='width:400px; text-align:center;padding:15px;' >
			<table id="seek"  border="1"   cellpadding='3' cellspacing='2' style='width:100%;' >
				...
				<tr class='seek_tr'>
                    <td   style="width:35%;" ><a id='lblXdatea'>生效日</a></td>
                    <td style="width:65%;  ">
				...
				<tr class='seek_tr'>
                    <td class='seek'  style="width:20%;"><a id='lblXcustno'>客戶編號</a></td>
                    <td>
                    <input class="txt" id="txtCustno" type="text" style="width:215px; font-size:medium;" />
                    </td>
                </tr>
                <tr class='seek_tr'>
                    <td class='seek'  style="width:20%;"><a id='lblXcust'>客戶名稱</a></td>
                    <td>
